...
if ( ! function_exists( 'foton_mikado_add_linea_icon_pack' ) ) {
	function foton_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new FotonMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_linea_icon_pack_option' ) ) {
	function foton_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_linea_icon_pack_option' );
}

class FotonMikadoClassLineaIcons implements iFotonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
