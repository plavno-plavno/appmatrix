...
add_action('init', 'ideothemo_solutions_types_init');

function ideothemo_solutions_types_init()
{

    // Solutions
    $labels = array(
        'name' => _x('Solutions', 'post type general name', 'ideo-themo'),
        'singular_name' => _x('Solutions', 'post type singular name', 'ideo-themo'),
        'menu_name' => _x('Solutions', 'admin menu', 'ideo-themo'),
        'name_admin_bar' => _x('Solutions', 'add new on admin bar', 'ideo-themo'),
        'add_new' => _x('Add New', 'book', 'ideo-themo'),
        'add_new_item' => __('Add New Solutions', 'ideo-themo'),
        'new_item' => __('New Solutions', 'ideo-themo'),
        'edit_item' => __('Edit Solutions', 'ideo-themo'),
        'view_item' => __('View Solutions', 'ideo-themo'),
        'all_items' => __('All Solutions', 'ideo-themo'),
        'search_items' => __('Search Solutions', 'ideo-themo'),
        'parent_item_colon' => __('Parent Solutions:', 'ideo-themo'),
        'not_found' => __('No Solutions found.', 'ideo-themo'),
        'not_found_in_trash' => __('No Solutions found in Trash.', 'ideo-themo')
    );


    $solutions_slug = 'solutions';
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
//        'rewrite' => array('slug' => $solutions_slug),
        'capability_type' => 'post',
        'has_archive' => false,
        'hierarchical' => false,
        'menu_position' => null,
    ...
    $args = array(
        ...
        'show_admin_column' => true,
        'query_var' => true,
        'rewrite' => array('slug' => 'solutions-categories'),
    );

    register_taxonomy('solutions_categories', array('solutions'), $args);
