...
if ( ! function_exists( 'foton_mikado_add_linear_icon_pack' ) ) {
	function foton_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new FotonMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_linear_icon_pack_option' ) ) {
	function foton_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_linear_icon_pack_option' );
}

class FotonMikadoClassLinearIcons implements iFotonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
