...
if ( ! function_exists( 'foton_mikado_add_dripicons_icon_pack' ) ) {
	function foton_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new FotonMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_dripicons_icon_pack_option' ) ) {
	function foton_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_dripicons_icon_pack_option' );
}

class FotonMikadoClassDripicons implements iFotonMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
