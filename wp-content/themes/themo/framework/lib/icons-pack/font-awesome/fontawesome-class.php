...
if ( ! function_exists( 'foton_mikado_add_font_awesome_icon_pack' ) ) {
	function foton_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new FotonMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_font_awesome_icon_pack_option' ) ) {
	function foton_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'foton_mikado_filter_add_icon_pack_into_social_options', 'foton_mikado_add_font_awesome_icon_pack_option' );
}

class FotonMikadoClassIconsFontAwesome implements iFotonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
