...
(function ($, ideo) {
    ...
    $('a').on(_eventtype, function (e) {
        ...
        if($this.data('toggle') == 'tab' || $this.data('toggle') == 'collapse' || $this.data('slide') || $this.hasClass('tg-media-button') || $this.data('val') || $this.hasClass('js--no-load')){
            return true;
        }
        ...
        if (
            ...
            ($this.attr('class') && $this.attr('class').indexOf('bwg_lightbox') !== -1) /* support photo-gallery plugin */
        ) {
            e.stopPropagation();
            return true;
        }
