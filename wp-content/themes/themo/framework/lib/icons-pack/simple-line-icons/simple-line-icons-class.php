...
if ( ! function_exists( 'foton_mikado_add_simple_line_icon_pack' ) ) {
	function foton_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new FotonMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_simple_line_icon_pack_option' ) ) {
	function foton_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'foton_mikado_filter_add_icon_pack_into_social_options', 'foton_mikado_add_simple_line_icon_pack_option' );
}

class FotonMikadoClassSimpleLineIcons implements iFotonMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'foton'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'foton'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'foton'),
            'icon-social-facebook'    => esc_html__('Facebook', 'foton'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'foton'),
            'icon-social-github'      => esc_html__('Github', 'foton'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'foton'),
            'icon-social-instagram'   => esc_html__('Instagram', 'foton'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'foton'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'foton'),
            'icon-social-reddit'      => esc_html__('Reddit', 'foton'),
            'icon-social-skype'       => esc_html__('Skype', 'foton'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'foton'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'foton'),
            'icon-social-spotify'     => esc_html__('Spotify', 'foton'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'foton'),
            'icon-social-twitter'     => esc_html__('Twitter', 'foton'),
            'icon-social-youtube'     => esc_html__('Youtube', 'foton')
        );
    }
