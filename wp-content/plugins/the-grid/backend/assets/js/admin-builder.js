...
(function($) {
	...
	function check_skin_style() {
		...
		if (skin_style === 'grid') {
			...
			$('.tg-skin-build-inner .tg-item-content-holder').hide();
		...
		if (skin_style === 'masonry' && !media_content) {
			...
			$('.tg-skin-build-inner .tg-item-media-holder').hide();
			$('.tomb-row.overlay_type').hide();
		} else {
			$content_none.attr('disabled', false);
			...
			$('.tg-skin-build-inner .tg-item-media-holder').show();
	...
	function check_item_size() {
		...
		$('.tg-skin-build-inner .tg-item-inner').width(col_nb*item_w);
		$('.tg-skin-build-inner .tg-item-media-holder').height(row_nb*item_w*ratio_Y/ratio_X);
	...
	function build_skin() {
		...
		if (typeof tg_skin_settings !== 'undefined') {
			...
			var $input, item, el, tp, st, element,
				...
				settings = JSON.parse( tg_skin_settings || '{}' ),
