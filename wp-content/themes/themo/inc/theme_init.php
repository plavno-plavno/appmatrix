<?php
define('IDEOTHEMO_VERSION', '1.4.7');
...
function ideothemo_scripts_styles()
{
	...
	wp_enqueue_style('ideothemo-style-1', IDEOTHEMO_INIT_DIR_URI . '/css/modules-responsive.css', array(), IDEOTHEMO_VERSION);
	wp_enqueue_style('ideothemo-style-2', IDEOTHEMO_INIT_DIR_URI . '/css/modules.min.css', array(), IDEOTHEMO_VERSION);
	
	wp_enqueue_style('fix-css-style', IDEOTHEMO_INIT_DIR_URI . '/css/fix-css-style.css', array(), IDEOTHEMO_VERSION);
...
function ideothemo_admin_scripts_styles()
{
    ...
    wp_enqueue_script('wp-color-picker-alpha', IDEOTHEMO_INIT_DIR_URI . '/js/wp-color-picker-alpha.min.js', array('wp-color-picker'), '2.1.3', true);
