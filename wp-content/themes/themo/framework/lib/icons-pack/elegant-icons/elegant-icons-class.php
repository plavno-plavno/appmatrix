...
if ( ! function_exists( 'foton_mikado_add_font_elegant_icon_pack' ) ) {
	function foton_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new FotonMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_font_elegant_icon_pack_option' ) ) {
	function foton_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'foton_mikado_filter_add_icon_pack_into_social_options', 'foton_mikado_add_font_elegant_icon_pack_option' );
}

class FotonMikadoClassIconsFontElegant implements iFotonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
