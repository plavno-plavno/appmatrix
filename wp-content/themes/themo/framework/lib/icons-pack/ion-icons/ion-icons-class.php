...
if ( ! function_exists( 'foton_mikado_add_ion_icon_pack' ) ) {
	function foton_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new FotonMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_collection', 'foton_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'foton_mikado_add_ion_icon_pack_option' ) ) {
	function foton_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'foton' );
		
		return $options;
	}
	
	add_filter( 'foton_mikado_filter_add_icon_pack_into_options', 'foton_mikado_add_ion_icon_pack_option' );
	add_filter( 'foton_mikado_filter_add_icon_pack_into_social_options', 'foton_mikado_add_ion_icon_pack_option' );
}

class FotonMikadoClassIonIcons implements iFotonMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
